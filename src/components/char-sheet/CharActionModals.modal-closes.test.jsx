...
describe('CharActionModals — HandOfHealingModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('dispatches buffs-updated on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ handOfHealingModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('hand-of-healing-close'));
    expect(setModalState).toHaveBeenCalledWith({ handOfHealingModal: null });
  });
});

describe('CharActionModals — FontOfMagicModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ fontOfMagicModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('font-of-magic-close'));
    expect(setModalState).toHaveBeenCalledWith({ fontOfMagicModal: null });
  });
});

describe('CharActionModals — ResourcePoolModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      ...
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('resource-pool-close'));
    expect(setModalState).toHaveBeenCalledWith({ resourcePoolModal: null });
  });
});

describe('CharActionModals — WildCompanionModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ wildCompanionModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('wild-companion-close'));
    expect(setModalState).toHaveBeenCalledWith({ wildCompanionModal: null });
  });
});

describe('CharActionModals — SetConditionModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ setConditionModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('set-condition-close'));
    expect(setModalState).toHaveBeenCalledWith({ setConditionModal: null });
  });
});

describe('CharActionModals — EyebiteEffectModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ eyebiteEffectModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('eyebite-close'));
    expect(setModalState).toHaveBeenCalledWith({ eyebiteEffectModal: null });
  });
});

describe('CharActionModals — moonlightStepResourceModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      ...
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('moonlight-step-resource-close'));
    expect(setModalState).toHaveBeenCalledWith({ moonlightStepResourceModal: null });
  });
});

describe('CharActionModals — saveAttackAoeModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ saveAttackAoeModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('save-attack-aoe-close'));
    expect(setModalState).toHaveBeenCalledWith({ saveAttackAoeModal: null });
  });
});

describe('CharActionModals — aoeConditionModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ aoeConditionModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('aoe-condition-close'));
    expect(setModalState).toHaveBeenCalledWith({ aoeConditionModal: null });
  });
});

describe('CharActionModals — fearModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ fearModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('fear-close'));
    expect(setModalState).toHaveBeenCalledWith({ fearModal: null });
  });
});

describe('CharActionModals — hypnoticPatternModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ hypnoticPatternModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('hypnotic-pattern-close'));
    expect(setModalState).toHaveBeenCalledWith({ hypnoticPatternModal: null });
  });
});

describe('CharActionModals — massSuggestionModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ massSuggestionModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('mass-suggestion-close'));
    expect(setModalState).toHaveBeenCalledWith({ massSuggestionModal: null });
  });
});

describe('CharActionModals — calmEmotionsModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ calmEmotionsModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('calm-emotions-close'));
    expect(setModalState).toHaveBeenCalledWith({ calmEmotionsModal: null });
  });
});

describe('CharActionModals — tashasLaughterModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ tashasLaughterModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('tashas-laughter-close'));
    expect(setModalState).toHaveBeenCalledWith({ tashasLaughterModal: null });
  });
});

describe('CharActionModals — silenceModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ silenceModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('silence-close'));
    expect(setModalState).toHaveBeenCalledWith({ silenceModal: null });
  });
});

describe('CharActionModals — elementalAttunementModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ elementalAttunementModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('elemental-attunement-close'));
    expect(setModalState).toHaveBeenCalledWith({ elementalAttunementModal: null });
  });
});

describe('CharActionModals — elementalBurstModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ elementalBurstModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('elemental-burst-close'));
    expect(setModalState).toHaveBeenCalledWith({ elementalBurstModal: null });
  });
});

describe('CharActionModals — divineSparkModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ divineSparkModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('divine-spark-close'));
    expect(setModalState).toHaveBeenCalledWith({ divineSparkModal: null });
  });
});

describe('CharActionModals — arcaneChargeModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ arcaneChargeModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('arcane-charge-close'));
    expect(setModalState).toHaveBeenCalledWith({ arcaneChargeModal: null });
  });
});

describe('CharActionModals — warMagicCantripModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ warMagicCantripModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('war-magic-cantrip-close'));
    expect(setModalState).toHaveBeenCalledWith({ warMagicCantripModal: null });
  });
});

describe('CharActionModals — warMagicSpellModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ warMagicSpellModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('war-magic-spell-close'));
    expect(setModalState).toHaveBeenCalledWith({ warMagicSpellModal: null });
  });
});

describe('CharActionModals — sacredWeaponModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ sacredWeaponModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('sacred-weapon-close'));
    expect(setModalState).toHaveBeenCalledWith({ sacredWeaponModal: null });
  });
});

describe('CharActionModals — primalCompanionBonusActionModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ primalCompanionBonusActionModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('primal-companion-bonus-action-close'));
    expect(setModalState).toHaveBeenCalledWith({ primalCompanionBonusActionModal: null });
  });
});

describe('CharActionModals — primalCompanionSummonModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ primalCompanionSummonModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('primal-companion-summon-close'));
    expect(setModalState).toHaveBeenCalledWith({ primalCompanionSummonModal: null });
  });
});

describe('CharActionModals — mistyWandererModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ mistyWandererModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('misty-wanderer-close'));
    expect(setModalState).toHaveBeenCalledWith({ mistyWandererModal: null });
  });
});

describe('CharActionModals — feyReinforcementsModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ feyReinforcementsModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('fey-reinforcements-close'));
    expect(setModalState).toHaveBeenCalledWith({ feyReinforcementsModal: null });
  });
});

describe('CharActionModals — stepsOfTheFeyTauntModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ stepsOfTheFeyTauntModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('steps-of-the-fey-taunt-close'));
    expect(setModalState).toHaveBeenCalledWith({ stepsOfTheFeyTauntModal: null });
  });
});

describe('CharActionModals — bonusActionChoiceModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ bonusActionChoiceModal: { action: {}, options: [] } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('bonus-action-choice-close'));
    expect(setModalState).toHaveBeenCalledWith({ bonusActionChoiceModal: null });
  });
});

describe('CharActionModals — stealthAttackModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ stealthAttackModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('stealth-attack-close'));
    expect(setModalState).toHaveBeenCalledWith({ stealthAttackModal: null });
  });
});

describe('CharActionModals — thirdEyeModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ thirdEyeModal: { action: {}, playerStats: {}, campaignName: 'test-campaign' } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('third-eye-close'));
    expect(setModalState).toHaveBeenCalledWith({ thirdEyeModal: null });
  });
});

describe('CharActionModals — soulstitchSpellsModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ soulstitchSpellsModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('soulstitch-spells-close'));
    expect(setModalState).toHaveBeenCalledWith({ soulstitchSpellsModal: null });
  });
});

describe('CharActionModals — illusoryRealityModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ illusoryRealityModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('illusory-reality-close'));
    expect(setModalState).toHaveBeenCalledWith({ illusoryRealityModal: null });
  });
});

describe('CharActionModals — arcaneWardRestoreModal close handler', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('closes modal on close', () => {
    ...
    render(<CharActionModals
      {...createBaseProps({})}
      modalState={{ arcaneWardRestoreModal: { action: {} } }}
      setModalState={setModalState}
    />);
    fireEvent.click(screen.getByTestId('arcane-ward-restore-close'));
    expect(setModalState).toHaveBeenCalledWith({ arcaneWardRestoreModal: null });
  });
});
