// Tests for CharActionModals modal close handlers — data-driven to avoid repetition.
// Each entry defines a modal key, the modalState payload, and the test-testid of the close button.
...
// ── Close Handler Test Data ──
// Each entry: { modalKey, modalState, closeTestId }

const closeHandlerTests = [
  { modalKey: 'handOfHealingModal', modalState: { handOfHealingModal: { action: {} } }, closeTestId: 'hand-of-healing-close', label: 'HandOfHealingModal' },
  { modalKey: 'fontOfMagicModal', modalState: { fontOfMagicModal: { action: {} } }, closeTestId: 'font-of-magic-close', label: 'FontOfMagicModal' },
  { modalKey: 'resourcePoolModal', modalState: { resourcePoolModal: { automation: {} } }, closeTestId: 'resource-pool-close', label: 'ResourcePoolModal' },
  { modalKey: 'wildCompanionModal', modalState: { wildCompanionModal: { action: {} } }, closeTestId: 'wild-companion-close', label: 'WildCompanionModal' },
  { modalKey: 'setConditionModal', modalState: { setConditionModal: { action: {} } }, closeTestId: 'set-condition-close', label: 'SetConditionModal' },
  { modalKey: 'eyebiteEffectModal', modalState: { eyebiteEffectModal: { action: {} } }, closeTestId: 'eyebite-close', label: 'EyebiteEffectModal' },
  { modalKey: 'moonlightStepResourceModal', modalState: { moonlightStepResourceModal: { automation: {} } }, closeTestId: 'moonlight-step-resource-close', label: 'moonlightStepResourceModal' },
  { modalKey: 'saveAttackAoeModal', modalState: { saveAttackAoeModal: { action: {} } }, closeTestId: 'save-attack-aoe-close', label: 'saveAttackAoeModal' },
  { modalKey: 'aoeConditionModal', modalState: { aoeConditionModal: { action: {} } }, closeTestId: 'aoe-condition-close', label: 'aoeConditionModal' },
  { modalKey: 'fearModal', modalState: { fearModal: { action: {} } }, closeTestId: 'fear-close', label: 'fearModal' },
  { modalKey: 'hypnoticPatternModal', modalState: { hypnoticPatternModal: { action: {} } }, closeTestId: 'hypnotic-pattern-close', label: 'hypnoticPatternModal' },
  { modalKey: 'massSuggestionModal', modalState: { massSuggestionModal: { action: {} } }, closeTestId: 'mass-suggestion-close', label: 'massSuggestionModal' },
  { modalKey: 'calmEmotionsModal', modalState: { calmEmotionsModal: { action: {} } }, closeTestId: 'calm-emotions-close', label: 'calmEmotionsModal' },
  { modalKey: 'tashasLaughterModal', modalState: { tashasLaughterModal: { action: {} } }, closeTestId: 'tashas-laughter-close', label: 'tashasLaughterModal' },
  { modalKey: 'silenceModal', modalState: { silenceModal: { action: {} } }, closeTestId: 'silence-close', label: 'silenceModal' },
  { modalKey: 'elementalAttunementModal', modalState: { elementalAttunementModal: { action: {} } }, closeTestId: 'elemental-attunement-close', label: 'elementalAttunementModal' },
  { modalKey: 'elementalBurstModal', modalState: { elementalBurstModal: { action: {} } }, closeTestId: 'elemental-burst-close', label: 'elementalBurstModal' },
  { modalKey: 'divineSparkModal', modalState: { divineSparkModal: { action: {} } }, closeTestId: 'divine-spark-close', label: 'divineSparkModal' },
  { modalKey: 'arcaneChargeModal', modalState: { arcaneChargeModal: { action: {} } }, closeTestId: 'arcane-charge-close', label: 'arcaneChargeModal' },
  { modalKey: 'warMagicCantripModal', modalState: { warMagicCantripModal: { action: {} } }, closeTestId: 'war-magic-cantrip-close', label: 'warMagicCantripModal' },
  { modalKey: 'warMagicSpellModal', modalState: { warMagicSpellModal: { action: {} } }, closeTestId: 'war-magic-spell-close', label: 'warMagicSpellModal' },
  { modalKey: 'sacredWeaponModal', modalState: { sacredWeaponModal: { action: {} } }, closeTestId: 'sacred-weapon-close', label: 'sacredWeaponModal' },
  { modalKey: 'primalCompanionBonusActionModal', modalState: { primalCompanionBonusActionModal: { action: {} } }, closeTestId: 'primal-companion-bonus-action-close', label: 'primalCompanionBonusActionModal' },
  { modalKey: 'primalCompanionSummonModal', modalState: { primalCompanionSummonModal: { action: {} } }, closeTestId: 'primal-companion-summon-close', label: 'primalCompanionSummonModal' },
  { modalKey: 'mistyWandererModal', modalState: { mistyWandererModal: { action: {} } }, closeTestId: 'misty-wanderer-close', label: 'mistyWandererModal' },
  { modalKey: 'feyReinforcementsModal', modalState: { feyReinforcementsModal: { action: {} } }, closeTestId: 'fey-reinforcements-close', label: 'feyReinforcementsModal' },
  { modalKey: 'stepsOfTheFeyTauntModal', modalState: { stepsOfTheFeyTauntModal: { action: {} } }, closeTestId: 'steps-of-the-fey-taunt-close', label: 'stepsOfTheFeyTauntModal' },
  { modalKey: 'bonusActionChoiceModal', modalState: { bonusActionChoiceModal: { action: {}, options: [] } }, closeTestId: 'bonus-action-choice-close', label: 'bonusActionChoiceModal' },
  { modalKey: 'stealthAttackModal', modalState: { stealthAttackModal: { action: {} } }, closeTestId: 'stealth-attack-close', label: 'stealthAttackModal' },
  { modalKey: 'thirdEyeModal', modalState: { thirdEyeModal: { action: {}, playerStats: {}, campaignName: 'test-campaign' } }, closeTestId: 'third-eye-close', label: 'thirdEyeModal' },
  { modalKey: 'soulstitchSpellsModal', modalState: { soulstitchSpellsModal: { action: {} } }, closeTestId: 'soulstitch-spells-close', label: 'soulstitchSpellsModal' },
  { modalKey: 'illusoryRealityModal', modalState: { illusoryRealityModal: { action: {} } }, closeTestId: 'illusory-reality-close', label: 'illusoryRealityModal' },
  { modalKey: 'arcaneWardRestoreModal', modalState: { arcaneWardRestoreModal: { action: {} } }, closeTestId: 'arcane-ward-restore-close', label: 'arcaneWardRestoreModal' },
];

describe('CharActionModals — modal close handlers', () => {
  for (const { modalKey, modalState, closeTestId, label } of closeHandlerTests) {
    describe(`${label} close handler`, () => {
      beforeEach(() => {
        vi.clearAllMocks();
      });
      ...
      it(`closes modal on close`, () => {
        ...
        expect(setModalState).toHaveBeenCalledWith({ [modalKey]: null });
      });
    });
  }
});
