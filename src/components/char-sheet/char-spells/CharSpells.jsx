            ...
            {(playerStats.spellAbilities && playerStats.spellAbilities.spells.length > 0) && <div className="spell-popup-parent">
                    ...
                    {pendingConfusion && (
                      <ConfusionModal
                        ...
                        campaignName={campaignName}
                        saveType="WIS"
                        saveDc={playerStats.spellAbilities?.saveDc || 8 + (playerStats.proficiency || 2)}
                        onClose={() => cfClearPending('confusion')}
                        metamagicCareful={false}
                        metamagicHeighten={null}
                      />
                    )}
                    {pendingWeb && (
                      <CreatureSelectionModal
