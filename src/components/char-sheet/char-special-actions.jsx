...
function CharSpecialActions({ playerStats }) {
    ...
    if(playerStats.fightingStyles && playerStats.fightingStyles.includes('Great Weapon Fighting') && !playerStats.specialActions.find((specialAction) => specialAction.name === 'Great Weapon Fighting')) {
    ...
    } else if(playerStats.fightingStyles && playerStats.fightingStyles.includes('Protection') && !playerStats.specialActions.find((specialAction) => specialAction.name === 'Protection')) {
