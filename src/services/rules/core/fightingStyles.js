...
/**
 * 5e: Interception fighting style - add reaction feature
 */
function addInterception5e(playerStats) {
 ...
 */
function addInterception2024(playerStats) {
    if (playerStats.class.fightingStyles && playerStats.class.fightingStyles.includes('Interception')) {
        const existingInterception = playerStats.reactions.find(r => r.name === 'Interception');
        if (!existingInterception) {
            playerStats.reactions.push({
...
/**
 * 5e: Protection fighting style - add reaction feature
 */
function addProtection5e(playerStats) {
 ...
 */
function addProtection2024(playerStats) {
    if (playerStats.class.fightingStyles && playerStats.class.fightingStyles.includes('Protection')) {
        const existingProtection = playerStats.reactions.find(r => r.name === 'Protection');
        if (!existingProtection) {
            playerStats.reactions.push({
...
/**
 * 5e: Thrown Weapon Fighting fighting style - add passive automation
 */
function addThrownWeaponFighting(playerStats) {
...
/**
 * 5e: Two-Weapon Fighting fighting style - add passive automation
 */
function addTwoWeaponFighting(playerStats) {
 ...
 */
function addBlessedWarrior(playerStats) {
 ...
 */
function addDruidicWarrior(playerStats) {
 ...
 */
function addSuperiorTechnique(playerStats) {
...
/**
 * Add fighting style features to playerStats (reactions and specialActions).
 */
export function addFightingStyleFeatures(playerStats, is2024) {
    if (!is2024) {
        addInterception5e(playerStats);
        addProtection5e(playerStats);
        addThrownWeaponFighting(playerStats);
        addTwoWeaponFighting(playerStats);
    }
    addBlessedWarrior(playerStats);
    addDruidicWarrior(playerStats);
    addSuperiorTechnique(playerStats);
    if (is2024) {
        addInterception2024(playerStats);
        addProtection2024(playerStats);
    }
}
